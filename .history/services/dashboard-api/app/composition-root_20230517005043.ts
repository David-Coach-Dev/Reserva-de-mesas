...
import { authenticatorProxyAdapters } from '../../../.history/services/dashboard-api/adapters/drivers/authenticator-proxy-adapters_20230517004729';
...
export const {authenticatorProxyAdapters}